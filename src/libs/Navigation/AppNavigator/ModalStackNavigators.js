 ...
 * @param {Object} [initialParams] that are passed to the rendering component
 * @returns {Object}
 */
const createRouteRenderingComponent = (name, getComponent, initialParams) => ({
...
const SplitDetailsModalStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('SplitDetails_Root', () => require('../../../pages/iou/SplitBillDetailsPage').default),
]);

const DetailsModalStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('Details_Root', () => require('../../../pages/DetailsPage').default),
]);

const ProfileModalStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('Profile_Root', () => require('../../../pages/ProfilePage').default),
]);
...
const SearchModalStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('Search_Root', () => require('../../../pages/SearchPage').default),
]);

const NewChatModalStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('NewChat_Root', () => require('../../../pages/NewChatSelectorPage').default),
]);
...
const NewTeachersUniteNavigator = createModalStackNavigator([
    createRouteRenderingComponent('SaveTheWorld_Root', () => require('../../../pages/TeachersUnite/SaveTheWorldPage').default),
    createRouteRenderingComponent('I_Know_A_Teacher', () => require('../../../pages/TeachersUnite/KnowATeacherPage').default),
    createRouteRenderingComponent('Intro_School_Principal', () => require('../../../pages/TeachersUnite/IntroSchoolPrincipalPage').default),
...
const SettingsModalStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('Settings_Root', () => require('../../../pages/settings/InitialSettingsPage').default),
    ...
    createRouteRenderingComponent('Settings_Security', () => require('../../../pages/settings/Security/SecuritySettingsPage').default),
    ...
    createRouteRenderingComponent('Settings_Add_Paypal_Me', () => require('../../../pages/settings/Wallet/AddPayPalMePage').default),
    ...
    createRouteRenderingComponent('Settings_Status', () => require('../../../pages/settings/Profile/CustomStatus/StatusPage').default),
    ...
    createRouteRenderingComponent('ReimbursementAccount', () => require('../../../pages/ReimbursementAccount/ReimbursementAccountPage').default, {stepToOpen: ''}),
...
const WalletStatementStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('WalletStatement_Root', () => require('../../../pages/wallet/WalletStatementPage').default),
]);

const FlagCommentStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('FlagComment_Root', () => require('../../../pages/FlagCommentPage').default),
]);
...
const SignInModalStackNavigator = createModalStackNavigator([
    createRouteRenderingComponent('SignIn_Root', () => require('../../../pages/signin/SignInModal').default),
]);
