...
export default {
    ...
    MONEY_REQUEST: {
        ...
        CURRENCY: createRouteWithGetter({     ':iouType/currency/:reportID?'                        : (iouType: string, reportID: string, currency: string, backTo: string) => `${iouType}/currency/${reportID}?currency=${currency}&backTo=${backTo}`}),
        ...
        CONFIRMATION: createRouteWithGetter({ ':iouType/confirmation/:reportID?'                    : (iouType: string, reportID = '') => `${iouType}/confirmation/${reportID}`}),
    },
